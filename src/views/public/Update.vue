<template>
    <div>
        <el-dialog title="修改联系人" :visible.sync="dialogFormVisible" @close="()=>{this.isok = true;
...
<script>
import { updateLike,getTypeList,getStationList,getCompanyList } from "@/api/public/likeman.js"
export default {
    name:"update",
    data(){
        return{
